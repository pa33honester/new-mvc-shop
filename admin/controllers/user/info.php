...
if (mysqli_num_rows(mysqli_query($linkConnectDB, "SELECT id FROM users WHERE id='$userId'")) == 0) {
    echo "<div style='padding-top: 200px' class='container'><div class='alert alert-danger' style='text-align: center;'><strong>NO!</strong> This user does not exist. <a href='javascript: history.go(-1)'>Return</a></div></div>";
