        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Information about feedback</h2>
                    <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                    ...
                    <div class="card">
                        ...
                        foreach ($orderDetail as $product) :
                            ...
                            ?>
                                        ...
                                        <td><?= $stt; ?></td>
                                            <td><a
                                                    href="product/<?= $product['id']; ?>-<?= $product['slug'] ?>"><?= $product['product_name']; ?></a>
                                            </td>
                                ...
                                <h3 style="font-weight: bold;text-align: center;">Into the total money :
                                    <?= number_format($order_total, 0, ',', '.'); ?> USD </h3>
                            ...
                            <ul class="header-dropdown">
                                <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="javascript:void(0);">Q/LY LEARNING</a></li>
                                        <li><a href="javascript:void(0);">Q/Reason for feedback</a></li>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?= $product['id'] ?></td>
                                            <td><a
                                                    href="admin.php?controller=product&amp;action=edit&amp;product_id=<?= $product['id']; ?>"><?= $product['product_name']; ?></a>
                                            </td>
                                            <td><?= $product ? number_format($product['product_price'], 0, ',', '.') : 0; ?>
                                            </td>
                                            <td><?php if ($product["saleoff"] == 1) {
                                                    echo number_format(($product['product_price'] - (($product['product_price']) * ($product['percentoff']) / 100)), 0, ',', '.');
                                                } ?></td>
                                            <td><?= $product['createDate'] ?></td>
                                            <td><?= '<image src="public/upload/products/' . $product['img1'] . '?time=' . time() . '" style="max-width:50px;" />'; ?>
                                            </td>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input name="name" disabled type="text"
                                    value="<?= $feedback ? $feedback['name'] : ''; ?>" class="form-control" id="name"
                                    placeholder="họ và tên thật..." required="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input name="email" disabled type="text"
                                    value="<?= $feedback ? $feedback['email'] : ''; ?>" class="form-control" id="color"
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input name="phone" disabled type="text"
                                    value="<?= $feedback ? $feedback['phone'] : ''; ?>" class="form-control"
                                    id="totalview" required placeholder="0123456789..." />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <textarea name="subject" disabled type="text" class="form-control" id="totalview"
                                    required
                                    placeholder="Nội dung phản hồi..."><?= $feedback ? $feedback['subject'] : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="form-group" style="text-align: center;">
                        ...
                        <a title="Approve" class="btn btn-info btn-icon"
                            href="admin.php?controller=feedback&action=approved&feedback_id=<?= $feedback['id'] ?>"> <i
                                class="zmdi zmdi-check-circle"></i></a>
                        <?php endif; ?>
                        <a onclick="return confirm('Are you sure to delete?')" title="Delete"
                            class="btn btn-danger btn-icon"
                            href="admin.php?controller=feedback&action=delete&feedback_id=<?= $feedback['id'] ?>"> <i
                                class="zmdi zmdi-delete"></i></a>
                        <a class="btn btn-primary waves-effect"
                            href="admin.php?controller=feedback&action=edit&feedback_id=<?= $feedback['id'] ?>">Corrective
                            Edit feedback</a>
                        <a class="btn btn-warning waves-effect" href="admin.php?controller=feedback">Return</a>
                        <a class="btn btn-success waves-effect"
                            href="admin.php?controller=feedback&action=reply&feedback_id=<?= $feedback['id'] ?>">Reply
                            feedback</a>
                    </div>
                </div>
            </div>
