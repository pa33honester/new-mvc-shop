        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <form class="card auth_form" action="admin.php?controller=home&action=login" role="form"
                        method="post">
                        <div class="header">
                        ...
                        <div class="body">
                            ...
                            <div class="input-group mb-3">
                                <input type="password" class="form-control" placeholder="Password" name="password"
                                    value="">
                                <div class="input-group-append">
                                    <span class="input-group-text"><a href="index.php?controller=forgot-password"
                                            class="forgot" title="Forgot password"><i
                                                class="zmdi zmdi-lock"></i></a></span>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary btn-block waves-effect waves-light">LOG
                                IN</button>
                            <div class="signin_with mt-3">
                                <p class="mb-0"><a href="index.php?controller=forgot-password"><i
                                            class="zmdi zmdi-lock"></i> Forgot password?</a></a></p>
                    ...
                    <div class="copyright text-center">
                        ...
                        <span>Design: <a href="https://thememakker.com/" target="_blank">WholesalesInfo</a></span><span> -
                            Developed by <a href="https://tanhongit.com" target="_blank">Dorian</a></span>
                    </div>
                </div>
